...
//{
//    public class StallReader:Base
//    {
//        //11格以内
//        public StallReader(Memo memo) : base(memo)
//        {
//        }
...
//            var items = new List<CgData.Models.Item>();
//            for (var i = 0; i < 50; i++)
//            {
...
//                var count = Memo.ReadInt(0x0061D860 + i * offset);
//                var price = Memo.ReadInt(0x0062D07C + i * 4);
//                var item = new CgData.Models.Item
//                {
//                    Name=name,
//                    DengJi = dengJi,
//                    ZhongLei = zhongLei,
...
//        private static int GetValue(string str, string attribute)
//        {
