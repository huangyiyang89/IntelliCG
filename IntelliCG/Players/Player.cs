...
namespace IntelliCG.Players
{
    ...
    public class Player:Base
    {
        ...
        public int Level => Memo.ReadInt(Memo.GetPointer(0x010AEF88) + 0x4);
        public bool IsMoving => Memo.ReadInt(0x005F6A48) != 65535;

        public int Line => Memo.ReadInt(0x009D6160,1);
        ...
        public Job Job
        {
            get
            {
                ...
                if (jobName.Contains("战斧")) return Job.ZhanFu;
                if (jobName.Contains("封印")) return Job.FengYin;
                return Job.Others;
            }
        }
        ...
        /// <summary>
        /// 26以下白 51以下黄76以下粉 大于75红
        /// </summary>
        public int InJury => Memo.ReadInt(Memo.GetPointer(0x010AEF88) + 0xEC);
    }
}
